package com.easy.panda.aspect;

import com.easy.panda.annotation.Idempotent;
import com.easy.panda.exception.IdempotentException;
...
public class IdempotentAspect {
	...
	private static final String APPCACHE_KEY = "idempotent";
	...
	@Pointcut("@annotation(com.easy.panda.annotation.Idempotent)")
	...
	public void beforePointCut(JoinPoint joinPoint) {
		...
		RMapCache<String, Object> rMapCache = redisson.getMapCache(APPCACHE_KEY);
	...
	public void afterPointCut(JoinPoint joinPoint) {
		...
		RMapCache<Object, Object> mapCache = redisson.getMapCache(APPCACHE_KEY);
		if (mapCache.size() == 0) {
			return;
		}
